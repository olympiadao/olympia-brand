...
const CARDS = [
  ...
  },
  {
    ...
    subtitle: 'Protocol-Funded Vault for Ethereum Classic',
    chips: ['Balance', 'Transactions', 'Governance', 'Live Data'],
    note: 'Live monitoring of the protocol vault. Transaction fee revenue funds the treasury.',
  ...
  // there rather than absent.
  {
    ...
    eyebrow: 'ETHEREUM CLASSIC DAO',
    title: 'Ethereum Classic DAO',
    subtitle: 'Building Software & Infrastructure for Global Adoption',
    chips: ['Core Clients', 'Infrastructure', 'Hashrate', 'Compliance'],
    note: 'Wyoming DAO LLC — the largest Proof-of-Work smart contract platform.',
